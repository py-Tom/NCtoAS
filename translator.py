"""Convert ISO 6983 code commands (G-code) to AS language."""
...
def translate(
    ...
    flag_g00, flag_g01, flag_g02, flag_g03, flag_g90, flag_g91 = (
        False,
        False,
        False,
        False,
    ...
    for line in clean_code.splitlines():
        ...
        if change:
            ...
            if (flag_g02 or flag_g03) and flag_g90:
                ...
                circle_approx = set_mid_point(
                    old_point, point, c_point, circle_approx_mode
                )
                as_code.writelines(
                    "C1MOVE workpiece + TRANS" + str(circle_approx) + "\n"
                )
